...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8933927;
      var PACKAGE_UUID = 'bae530f2-4c48-404c-9793-4c3ed79a7e4d';
...
Module['FS_createPath']('/', 'MUSIC', true, true);
    ...
    new DataRequest(2623937, 2840279, 0, 0).open('GET', '/DATA/WGP/-01.WGP');
    new DataRequest(2840279, 3148557, 0, 0).open('GET', '/DATA/WGP/TITLE1.BMP');
    new DataRequest(3148557, 3347907, 0, 0).open('GET', '/DATA/WGP/-04.WGP');
    new DataRequest(3347907, 3600985, 0, 0).open('GET', '/DATA/WGP/-02.WGP');
    new DataRequest(3600985, 3909263, 0, 0).open('GET', '/DATA/WGP/TITLE2.BMP');
    new DataRequest(3909263, 4217541, 0, 0).open('GET', '/DATA/WGP/TITLE.BMP');
    new DataRequest(4217541, 4217794, 0, 0).open('GET', '/DATA/SCN/-00.SCN');
    new DataRequest(4217794, 4220831, 0, 0).open('GET', '/DATA/SCN/-03.SCN');
    new DataRequest(4220831, 4222157, 0, 0).open('GET', '/DATA/SCN/-02.SCN');
    new DataRequest(4222157, 4224245, 0, 0).open('GET', '/DATA/SCN/-01.SCN');
    new DataRequest(4224245, 4225991, 0, 0).open('GET', '/DATA/SCN/-04.SCN');
    new DataRequest(4225991, 4226254, 0, 0).open('GET', '/DATA/01/PRIEST.MOV');
    new DataRequest(4226254, 4226818, 0, 0).open('GET', '/DATA/01/KNIFE.SPR');
    new DataRequest(4226818, 4228003, 0, 0).open('GET', '/DATA/01/GIRL.MOV');
    new DataRequest(4228003, 4356309, 0, 0).open('GET', '/DATA/01/PRIEST.SPR');
    new DataRequest(4356309, 4356395, 0, 0).open('GET', '/DATA/01/VIEW.MOV');
    new DataRequest(4356395, 4357292, 0, 0).open('GET', '/DATA/01/EXTRA.MOV');
    new DataRequest(4357292, 4573418, 0, 0).open('GET', '/DATA/01/EXTRA.SPR');
    new DataRequest(4573418, 4574906, 0, 0).open('GET', '/DATA/01/VIEW.SPR');
    new DataRequest(4574906, 4575056, 0, 0).open('GET', '/DATA/01/PTER.MOV');
    new DataRequest(4575056, 4576934, 0, 0).open('GET', '/DATA/01/PTER.SPR');
    new DataRequest(4576934, 4721670, 0, 0).open('GET', '/DATA/01/GIRL.SPR');
    new DataRequest(4721670, 4723344, 0, 0).open('GET', '/DATA/03/FOOD.SPR');
    new DataRequest(4723344, 4723640, 0, 0).open('GET', '/DATA/03/FOOD.MOV');
    new DataRequest(4723640, 6216078, 0, 0).open('GET', '/DATA/03/ACRO.SPR');
    new DataRequest(6216078, 6220611, 0, 0).open('GET', '/DATA/03/ACRO.MOV');
    new DataRequest(6220611, 8933927, 0, 1).open('GET', '/MUSIC/track03.ogg');
